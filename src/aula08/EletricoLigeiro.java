...
public class EletricoLigeiro extends AutomovelLigeiro implements VeiculoEletrico {
    private int autonomiaMax;
    private int autonomia;
    private int bateria;

    public EletricoLigeiro(String matricula, String marca, String modelo, int potencia, String nQuadro, int capBagageira, int autonomiaMax,int bateria) {
